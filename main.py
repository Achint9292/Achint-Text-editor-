...
main_application.title('Achint-pad text editor')
#main menu########################################3
main_menu = tk.Menu()
#file icons
...
def save_as(event=None):
    ...
    try:
        ...
        return
file.add_command(label='save_as', image=new_icon, compound=tk.LEFT, accelerator='Ctrl+Alt+s', command=save_as)
##exit function
file.add_command(label='exit', image=new_icon, compound=tk.LEFT, accelerator='Ctrl+E')
#edit commands
############ find functionality
